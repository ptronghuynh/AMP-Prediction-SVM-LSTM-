...
**Antimicrobial Peptide Prediction from Microbial Protein Sequences: A Comparison of SVM and LSTM**
...
| Model | Test n | Accuracy | Macro F1 | AUC-ROC | Note |
|---|---:|---:|---:|---:|---|
| SVM-combined | 6,000 | 0.97 | 0.97 | 0.9962 | Notebook output |
| LSTM-combined | 6,000 | 0.95 | 0.95 | Not printed | Notebook output |
| BiLSTM-MHA | 6,000 | 0.97 | 0.97 | Not printed | Notebook output |
...
- Raw paired predictions are represented as templates in `results/raw_predictions/`. Formal McNemar and DeLong tests should be run only after raw per-sample predictions are regenerated from the fixed split manifest.
